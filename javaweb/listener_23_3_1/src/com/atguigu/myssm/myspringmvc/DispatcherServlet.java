...
public class DispatcherServlet extends ViewBaseServlet {
    ...
    public void init() throws ServletException {
        super.init();
        // 从ServletContextListener设置的作用域取出beanFactory1对象
        ServletContext servletContext = getServletContext();
        Object beanFactory1 = servletContext.getAttribute("beanFactory");
        ...
        try {
            ...
            for (Method method : methods) {
                if (operate.equals(method.getName())) {
                    ...
                    Object[] parameterValues = new Object[par_len];
            ...
            */
            ...
            throw new DispatcherServletException("Dispatcher出错了...");
        }
    }
}
